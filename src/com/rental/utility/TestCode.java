...
public class TestCode {
    ...
    public void sendTestCode(String userphone,String testCode){
        ...
        //替换成你的AK
        final String accessKeyId = "LTAIGY0mHpclCGUS";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "BilNUsLpCSRwHXGvAgLABqCclw1hMe";//你的accessKeySecret，参考本文档步骤2
